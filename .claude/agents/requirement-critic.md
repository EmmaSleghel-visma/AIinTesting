...
This is stage 1 of a testing pipeline. When the requirements are sharp enough to plan against,
hand the **Acceptance Criteria** and **Risk Surface** to the `test-planner` agent with this
intent:

> The requirements below have been reviewed and sharpened into testable acceptance criteria.
> Create a comprehensive test plan that covers every acceptance criterion, plus the edge cases
> and risks flagged in the critique. Use the acceptance criteria as the source of truth.

A human should review and approve before the handoff fires.